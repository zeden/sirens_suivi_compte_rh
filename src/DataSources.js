...
export const FILTRES_RECHERCHE = [
  ...
  },
  {
    value: "FILTER_2",
    name:
      "Personnels en fin de détachement, en fin de mise à disponibilité ou en fin de mise à disposition."
  },
  {
    value: "FILTER_3",
    name:
      "Personnels en fin de détachement, en fin de mise à disponibilité ou en fin de mise à disposition entre date A et date B."
  },
...
FILTRES_RECHERCHE.map(function(Item, index) {
  ...
  for (let i = 1; i <= random; i++) {
    Item.Agents.push({
      ...
      situation: casual.random_element([
        "vacataire",
        "hébergé",
        "fonctionnaire"
      ]),
...
export const FILTRES_INDICATEURS = [
  ...
  {
    name:
      "Lister les personnels actifs dans le LDAP mais hors contrat dans Mangue (inactifs)"
  },
  {
    name:
      "Lister les personnels actifs dans le AD mais hors contrat dans Mangue (inactifs)"
  },
  {
    name:
      "Lister les personnels actifs dans Partage mais hors contrat dans Mangue (inactifs)"
  },
  {
    name:
      "Lister les personnels actifs dans X applications mais hors contrat dans Mangue"
  },
  {
    name:
      "Lister les personnels actifs dans X applications mais hors contrat dans Mangue"
